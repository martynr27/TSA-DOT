...
# Outputs:
# 1. Time Series Plot:
#    - Qin (near-surface runoff)
#    - Qout_quick (Quick TSA Outflow): Water leaving the TSA through the outlet pipe or as overflow
#    - Attenuation Effect: Difference between Qin and Qout_quick indicates attenuation capacity
